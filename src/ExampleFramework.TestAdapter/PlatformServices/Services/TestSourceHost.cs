...
#pragma warning restore SA1214 // Readonly fields should appear before non-readonly fields
    ...
    internal TestSourceHost(string sourceFileName, IRunSettings? runSettings, IFrameworkHandle? frameworkHandle, IAppDomain appDomain)
    {
        ...
        _isAppDomainCreationDisabled = TestAdapterSettings.IsAppDomainCreationDisabled(_runSettings?.SettingsXml);
    }
    ...
    internal virtual List<string> GetResolutionPaths(string sourceFileName, bool isPortableMode)
    {
        ...
        if (!isPortableMode)
        {
            ...
            if (pathToPublicAssemblies != null &&
                !string.IsNullOrWhiteSpace(pathToPublicAssemblies)
            ...
            if (pathToPrivateAssemblies != null &&
                !string.IsNullOrWhiteSpace(pathToPrivateAssemblies)
    ...
    {
        return DeploymentUtilityBase.GetConfigFile(new FileUtility(), sourceFileName);
    }
    ...
    private static void AddSearchDirectoriesSpecifiedInRunSettingsToAssemblyResolver(AssemblyResolver assemblyResolver, string baseDirectory)
    {
        ...
        TestAdapterSettings adapterSettings = TestSettingsProvider.Settings;
