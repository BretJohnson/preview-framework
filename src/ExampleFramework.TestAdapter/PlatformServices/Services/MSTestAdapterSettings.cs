...
public class TestAdapterSettings
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TestAdapterSettings"/> class.
    /// </summary>
    public TestAdapterSettings()
    {
    ...
    /// <returns>An instance of the <see cref="TestAdapterSettings"/> class.</returns>
    public static TestAdapterSettings ToSettings(XmlReader reader)
    {
        ...
        //     </AssemblyResolution>
        // </MSTestV2>
        TestAdapterSettings settings = TestSettingsProvider.Settings;
