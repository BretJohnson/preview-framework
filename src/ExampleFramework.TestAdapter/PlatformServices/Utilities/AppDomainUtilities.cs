...
using ExampleFramework.TestAdapter.PlatformServices.Deployment;
...
internal static class AppDomainUtilities
{
    ...
    internal static string GetTargetFrameworkVersionString(string testSourcePath)
    {
        ...
        SetConfigurationFile(appDomainSetup, DeploymentUtilityBase.GetConfigFile(new FileUtility(), testSourcePath));
