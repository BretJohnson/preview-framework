...
internal static class TestCaseExtensions
{
    ...
    internal static TestElement ToTestElement(this TestCase testCase, string source)
    {
        ...
        TestElement testElement = new TestElement(testMethod)
        {
#if false
            IsAsync = isAsync,
        ...
        if (!string.IsNullOrWhiteSpace(cssProjectStructure))
        {
