...
public class UnitTestResult
{
    ...
    internal TestResult ToTestResult(TestCase testCase, DateTimeOffset startTime, DateTimeOffset endTime, string computerName, TestSettings currentSettings)
    {
        ...
        testResult.SetPropertyValue(Constants.ParentExecIdProperty, this.ParentExecId);
        testResult.SetPropertyValue(Constants.InnerResultsCountProperty, this.InnerResultsCount);
        ...
        {
            string debugTraceMessagesInStdOut = string.Format(CultureInfo.CurrentCulture, "{2}{2}{0}{2}{1}", Resource.DebugTraceBanner, this.DebugTrace, Environment.NewLine);
        ...
        {
            string testContextMessagesInStdOut = string.Format(CultureInfo.InvariantCulture, "{2}{2}{0}{2}{1}", Resource.TestContextMessageBanner, this.TestContextMessages, Environment.NewLine);
