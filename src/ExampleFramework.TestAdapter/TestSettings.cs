...
public class TestSettings
{
    ...
    /// </summary>
    private static TestSettings? s_currentSettings;
    ...
    {
        get => s_currentSettings ??= new TestSettings();
    ...
    public static void PopulateSettings(IDiscoveryContext? context)
    {
        ...
        if (context == null || context.RunSettings == null || context.RunSettings.SettingsXml == null || string.IsNullOrEmpty(context.RunSettings.SettingsXml))
        {
