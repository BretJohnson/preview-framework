...
internal static class StackTraceHelper
{
    ...
    /// </summary>
    // TODO: Perhaps exclude MSTest/NUnit/XUnit etc Assert types in the future, as well as ExampleFramework implementation types
    //private static readonly List<string> TypesToBeExcluded = new() { typeof(Assert).Namespace!, typeof(ExampleFrameworkTestExecutor).Namespace! };
    private static readonly List<string> TypesToBeExcluded = new() { typeof(ExampleFrameworkTestExecutor).Namespace! };
    ...
    {
        DebugEx.Assert(!string.IsNullOrEmpty(stackTrace), "stack trace should be non-empty.");
